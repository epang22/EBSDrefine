...
% *have not checked that coordinate systems agree!
% 2/7/20 (Edward Pang, MIT)
% Change log:
% -8/20/20 ELP: make euler angles double (to prevent singularities),
% comment out inversion symmetry elements, deal with triclinic symmetry in
% disorientation calcs
...
%%% make sure euler angles are double for calcs
euler1 = double(euler1);
euler2 = double(euler2);
...
else    % triclinic symmetry
    % don't need to do anything, disorient already set to misorient
end
